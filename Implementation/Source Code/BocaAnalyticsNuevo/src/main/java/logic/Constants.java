...
public class Constants {
  public static int SENSITIVITY = 23;//used to set min and max for the green color
  public static int GREEN = 60;//value for green in hsv format
  public static int SV = 100;//min value of SV in an HSV format when detecting green pixels
  
  public static int MAXSIZE = 1135;//maximun size of a countour
  public static int minValue = 0;//min value to normalize an image
  public static int maxValue = 180;//max value to normalize an image
    
  public static Point SCOREPOINT1 = new Point(5,5);//point to paint the scoreboard black
  public static Point SCOREPOINT2 = new Point(250,75);//point to paint the scoreboard black
